...
import { CalendarIcon, PlusCircle, Trash2, Save, XCircle, FileUp, Hash, DollarSign, BookOpen, Link as LinkIcon, NotebookText, Truck } from "lucide-react";
...
export function SupplyBillForm({
  initialData,
  isEditing,
  onSave,
  onCancelEdit,
    ...
    <Card className="w-full max-w-4xl mx-auto shadow-xl mb-8">
      <CardHeader>
        <CardTitle className="font-headline text-2xl flex items-center gap-2">
          ...
          {isEditing ? "Edit Supply Bill" : "Add New Supply Bill"}
        </CardTitle>
